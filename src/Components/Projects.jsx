        ...
        <div className="fixed inset-0 bg-gray-900 bg-opacity-90 flex justify-center items-center">
          <div className="bg-neutral-800 p-4 rounded-lg relative m-4 lg:m-64 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center pb-4">
              ...
              <div>
              <div>Rescaldani Producciones es una empresa de eventos ubicada en leones. Requerian una web para enseñar un poco de su trabajo así que la desarrolle con React, TailwindCSS, JavaScript, entre otras tecnologías</div>
                <a href="https://rescaldani-producciones.vercel.app/" className="flex gap-2 text-sky-600 hover:text-sky-800">Rescaldani Producciones<FaExternalLinkAlt /></a>
              </div>
            </div>
